...
public class DiscreteRangeHoldingsParserTest {
 ...
 public void testPrepareString() {
  ...
  public void testAddtoCurrentYearRanges() {
    ...
    Integer[] expectArray = continuousRangeToCurrent(2007);
    List expectList = Arrays.asList(expectArray);
    assertEquals(expectList, resultList);
  ...
  public void testGetYearsHeld() {
    ...
    Integer[] a1 = new Integer[]{1994, 1995, 1996};
    Integer[] a2 = continuousRangeToCurrent(2007);
    Integer[] expectArray = mergeArrays(a1, a2);
    List expectList = Arrays.asList(expectArray);
  ...
  public void testExpressions() {
    ...
    expectArray = continuousRangeToCurrent(2010);
    expectList = Arrays.asList(expectArray);
    years = hp.removeDuplicateYears(years);
    //System.out.println("For holdings = " + holdings + " Expecting " + expectList + "; got " + years);
    assertEquals(expectList, years);
  ...
  public void testMergeArrays() {
    ...
    Assert.assertArrayEquals(new Integer[]{1, 2, 3, 4, 5, 6, 7, 8}, mergeArrays(a1, a2));
  }
  
  private Integer[] mergeArrays(Integer[] ... years) {
  ...
  private Integer[] continuousRangeToCurrent(int startsWith) {
    List<Integer> result = new ArrayList<>();
    LocalDate today = LocalDate.now();
    Integer thisYear = today.getYear();
    for (Integer i = startsWith; i <= thisYear; i++) {
      result.add(i);
    }
    Integer[] resultArray = new Integer[result.size()];
    return result.toArray(resultArray);
