 ...
 * 
 * This information is directly related to data available in a MARC Bib record for the item requested.
 */
public class Bib {
  ...
  public String toString() {
    return "Bib{" + "oclcNumber=" + oclcNumber + ", authorName=" + authorName + ", title=" + title + ", publisher=" + publisher + ", placeOfPublication=" + placeOfPublication + ", publicationDate=" + publicationDate + ", issn=" + issn + ", isbn=" + isbn + ", edition=" + edition + ", corporateAuthor=" + corporateAuthor + ", dissertationNumber=" + dissertationNumber + ", ericIdentifier=" + ericIdentifier + ", recordType=" + recordType + ", seriality=" + seriality + ", multipartLevel=" + getMultipartLevel() + '}';
  }
