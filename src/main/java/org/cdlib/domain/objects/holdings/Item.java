...
public class Item {
  ...
  public String toString() {
    return "Item{" + "oclcNumber=" + oclcNumber + ", carrier=" + carrier + ", circStatus=" + circStatus + ", seriality=" + seriality + ", shelvingLocation=" + shelvingLocation + ", opacShelvingLocationName=" + opacShelvingLocationName + ", callNumber=" + callNumber + ", summaryHoldings=" + summaryHoldings + '}';
  }
